    ...
    >
      <div className="flex items-center gap-3">
        <button
          ...
          className="sm:hidden"
          style={{ background: "transparent", border: "none", color: "#aeb7cc", cursor: "pointer", padding: 4, display: "flex", alignItems: "center" }}
          aria-label="Menu"
        >
          <Menu size={18} />
        </button>
      ...
      <div className="flex items-center gap-3">
        <ManualTelaButton />
        <span className="hidden sm:inline" style={{ color: "#aeb7cc", fontSize: 11, fontFamily: "var(--font-geist-sans), system-ui, sans-serif" }}>
          <span style={{ color: "#C8102E" }}>›</span> {email}
        </span>
        <span className="sm:hidden" style={{ color: "#aeb7cc", fontSize: 10, fontFamily: "var(--font-geist-sans), system-ui, sans-serif", maxWidth: 130, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
          {email.split("@")[0]}
        </span>
        <button
