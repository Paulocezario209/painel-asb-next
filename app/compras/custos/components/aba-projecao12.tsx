        ...
        <tbody>
          {d.linhas.map((l) => (
            <tr key={l.mes} style={{ borderBottom: "1px solid #0b0f1d", opacity: l.status === "projecao" ? 0.7 : 1 }}>
              ...
              <td style={{ ...td, textAlign: "center" }}>{l.nivel !== "ideal" && l.nivel !== "projecao" ? <span style={{ fontSize: 9, color: l.cor, fontWeight: 700, fontFamily: theme.font.label }}>{l.label}</span> : "—"}</td>
            </tr>
          ))}
