...
export function RecompraLista({ rows }: { rows: RecompraRow[] }) {
  ...
  // Agrupa por vendedor (carteira separada, nunca misturada).
  ...
  return (
    <div className="space-y-4">
      ...
      {vendedores.map(([vend, list]) => {
        ...
        return (
          <div key={vend} className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4">
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-[#2a2a2a]">
              <h2 className="text-xs font-bold uppercase tracking-wider text-white">{vend}</h2>
              <span className="text-xs text-gray-500 ml-auto">{sorted.length} clientes</span>
            </div>
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full grid grid-cols-[auto_2fr_1fr_1fr_auto] gap-2 items-center p-3 text-xs text-left hover:bg-[#181818] transition-colors"
                    >
                      <span
                      ...
                      <span className="text-gray-400 truncate">
                        <span className="text-gray-500 text-[10px]">Cesta:</span>{" "}
